...
DropdownView.prototype.createDropdown = function(params) {
    ...
    dropdown += 'dropdown default"><div class="dropdown-head"><div class="expand kit-arrow"></div><input readonly="readonly" type="text" name="';
    ...
    dropdown += '" class="dropdown-input kit-form-input search-';
