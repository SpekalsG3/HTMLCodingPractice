(function($) {
    ...
    $.fn.dropdown = function(params = {}) {
        for (var i = 0; i < this.length; i++) {
            ...
            this.controller = new DropdownController(view, model);
        }
    }
...
DropdownController.prototype.reduceValue = function(target) {
    ...
    target.parentNode.children[1].setAttribute("value", newValue);
...
DropdownView.prototype.createDropdown = function(params) {
    ...
    if (params.options != undefined) {
        for (var i = 0; i < params.options.length; i++) {
            dropdown += '<div class="dropdown-option"><div class="option-title">' + params.options[i].title + '</div><div class="option-buttons" data-index="' + i + '"><div class="option-less option-btn disabled">-</div><input readonly="readonly" class="option-amount" name="' + params.options[i].title + '" value="';
