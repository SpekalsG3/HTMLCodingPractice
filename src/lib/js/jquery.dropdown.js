...
DropdownController.prototype.createDropdown = function(params) {
    ...
    if (params.options != undefined) {
        for (var i = 0; i < params.options.length; i++) {
            dropdown += '<div class="dropdown__option"><div class="dropdown__title">' + params.options[i].title + '</div><div class="dropdown__buttons" data-index="' + i + '"><div class="dropdown__less dropdown__button dropdown__button_disabled">-</div><input readonly="readonly" class="dropdown__value" name="' + params.options[i].title + '" value="';
...
DropdownController.prototype.clear = function() {
    ...
    this.DropdownView.$dropdown.find(".dropdown__less").removeClass("dropdown__button_disabled").addClass("dropdown__button_disabled");
    this.DropdownView.$dropdown.find(".dropdown__more").removeClass("dropdown__button_disabled");
