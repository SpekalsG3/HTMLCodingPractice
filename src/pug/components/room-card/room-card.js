...
$(".content__rooms a").click(function(e) {
  ...
  if (targetClassName == "page__arrow" || targetClassName == "room-card__gallery--prev" || targetClassName == "room-card__gallery--next")
    return;
  window.location.href = e.currentTarget.href + "&" + window.location.search.slice(1);
});

$(".room-card__gallery--prev").click(function(e) {
...
$(".room-card__gallery--next").click(function() {
  var index = parseInt(this.parentNode.getAttribute("data-index"));
